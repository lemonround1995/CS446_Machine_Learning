...
class LearningTests(unittest.TestCase):
    ...
    def test_learning_obj2(self):
        ...
        unary_beliefs = [tf.constant([[1, 0], [0, 1],[0, 1]]),tf.constant([[1, 0], [1, 0],[1, 0]]) ]
        pair_beliefs = [tf.constant([[1, 0, 0, 0], [0, 1, 0, 0]]), tf.constant([[1, 0, 0, 0], [0, 0, 0, 1]])]
        unary_potentials = [tf.constant([[1, 1], [1, 1], [1, 1]]), tf.constant([[1, 1], [1, 0], [1, 1]])]
